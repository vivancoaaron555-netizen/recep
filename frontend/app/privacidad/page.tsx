...
const sections = [
  ...
  {
    title: '13. Contenido de los usuarios',
    body: `El usuario es el único responsable del contenido que configura, sube o introduce en el servicio (instrucciones, prompts, datos, mensajes). Recept.ai no se hace responsable si dicho contenido infringe derechos de autor de terceros o resulta ilícito, inapropiado o indebido: el usuario responde íntegramente del mismo y de las consecuencias legales. Colaboraremos con las autoridades competentes ante cualquier contenido ilegal que se detecte.`,
  },
  {
    title: '14. Arbitraje',
