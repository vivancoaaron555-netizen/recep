...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  const TrialBanner = () => {
    if (trialExpired) {
      return (
        <div className="mb-6 p-4 rounded-xl bg-gradient-to-r from-purple-700 to-purple-900 border border-amber-400/50 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            <AlertTriangle className="w-5 h-5 text-amber-400 flex-shrink-0" />
            <div>
              <p className="font-semibold text-sm text-amber-400">Tu prueba gratuita terminó</p>
              <p className="text-xs text-amber-200/90">Tu recepcionista está pausada. Activa tu plan para continuar.</p>
            </div>
          </div>
      ...
      return (
        <div className="mb-6 p-4 rounded-xl bg-gradient-to-r from-purple-700 to-purple-900 border border-amber-400/50 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm text-amber-400">Prueba gratis</p>
